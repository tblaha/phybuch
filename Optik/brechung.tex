...
Das Phänomen der Brechung ist an Diagramm \ref{fig:brechung}\endnote{\glqq Refraction - Huygens-Fresnel principle\grqq{} von Arne Nordmann (norro) - Own illustration, based on Image:Wellen-Brechung.png and Image:Huygens\_brechung.png. Lizenziert unter CC BY-SA 3.0 über Wikimedia Commons - \url{https://commons.wikimedia.org/wiki/File:Refraction\_-\_Huygens-Fresnel\_principle.svg}} mit dem Huygens'schen Prinzip (\referenz{subsec:ausbreitung}) zu erklären.
...
Dazu kommt eine Wellenlängenänderung im neuen Medium, da die Frequenz gewahrt wird und sich die Ausbreitungsgeschwindigkeit ändert (Siehe: \gleichungsreferenz{eq:wellen_c}).
