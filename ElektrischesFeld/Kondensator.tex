...
Durch den Überschuss positiver Ladungen auf der einen Seite und negativer Ladungen auf der Anderen, ergibt sich ein homogenes Magnetfeld zwischen den parallelen Platten.\endnote{„E Feld Kondensator“. Von Wikibooks - \url{https://de.wikibooks.org/wiki/Datei:E_Feld_Kondensator.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{CapsParallel}
	\caption{Parallelschaltung zweier Kapazitäten (= Kondensatoren) $C_1$ und $C_2$}
\end{figure}

Wenn Kondensatoren in einem Stromkreis parallel\endnote{\glqq Kondensatorenschaltung parallel\grqq{} von Till Blaha - Eigenes Werk. Lizenziert unter Gemeinfrei.} geschaltet werden, addieren sich die Kapazitäten. Man kann sagen, dass die effektive Platte größer wird und daher mehr Ladung pro Spannung tragen kann (Siehe \gleichungsreferenz{eq:kapazitaet} und \ref{eq:bestimmung_kondensator}):
