...
\begin{quote}
Eine Spule leitet Gleichstrom wie ein normaler Draht. Nur beim Ein- und Ausschalten gibt es jeweils eine Zeitverzögerung im Stromfluss, die durch den Auf- und Abbau des Magnetfeldes verursacht wird. Unter Wechselstrombedingungen kommt es bei jedem Wechsel der Stromrichtung zu diesen Verzögerungen. (\glqq BLINDLEISTUNG-ADE094210\grqq{} herausgegeben von \textsc{SMA Solar Technology AG}, Seite 8\endnote{\glqq BLINDLEISTUNG-ADE094210\grqq{} - \url{http://files.sma.de/dl/10040/BLINDLEISTUNG-ADE094210.pdf}})
\end{quote}
