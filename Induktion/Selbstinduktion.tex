...
Wenn in einem Stromkreis (z.B. Abbildung \ref{fig:SchaltkreisGlimmlampe}\endnote{\glqq SelbstinduktionGlimmlampeSchaltkreis\grqq{} von Till Blaha - Eigenes Werk. Lizenziert unter Gemeinfrei}) eine Spule mit Strom durchflossen ist und sich in ihr das Magnetfeld vollständig aufgebaut hat, wird bei einer abrupten Unterbrechung des Stromkreises das Magnetfeld zusammenbrechen und aufgrund dieser starken Änderung ($\Delta t$ ist sehr klein) eine hohe, entgegengesetzt gepolte Spannung induziert.

\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{SelbstinduktionGlimmlampe}
