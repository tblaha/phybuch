...
\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth]{1Ordnung_Final}
...
\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth]{2Ordnung_Final}
...
\noindent Hinweis 2: \gleichungsreferenz{eq:wellen_c}
\end{Aufgabe}
